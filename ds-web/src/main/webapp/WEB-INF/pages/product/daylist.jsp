                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button style="position: relative;top: 12px;left:40px;" type="button" class="btn btn-primary" onclick="toadd()">新增日息产品</button>
                                    </td>
...
<script src="/static/pages/product/daylist.js"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
<script>
    //去往编辑页面
    function toedit(id){
        window.location.href="<%=path%>/product/toeditday/"+id;
    }

    //去往新增页面
    function toadd(){
        window.location.href="<%=path%>/product/toaddday";
    }
