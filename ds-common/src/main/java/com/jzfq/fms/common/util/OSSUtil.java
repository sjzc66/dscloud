...
public class OSSUtil {
    ...
    //阿里云API的内或外网域名(内网)
    //private static String ENDPOINT = "jzfq-fms-test.oss-cn-beijing-internal.aliyuncs.com";

    //阿里云API的密钥Access Key ID
    private static String ACCESS_KEY_ID = "LTAIi16Aj2Lcaqiv";
    //阿里云API的密钥Access Key Secret
    private static String ACCESS_KEY_SECRET = "k6rEjHghLzHfy7YQ4Z0ZFmZGnIJk1Q";
     ...
     * */
    public static final String uploadObject2OSS(OSSClient client, File file, String fileName, String bucketName, String diskName) {
        ...
        try {
            ...
            LOG.info("上传阿里云OSS服务器异常." + e.getMessage(), e);
        }
        return resultStr;
    }
     ...
     * @return
     */
    public static final String getUrl(String bucketName, String key) {
